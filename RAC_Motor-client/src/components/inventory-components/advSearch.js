...
let cancelToken
    const handleFilter = async (e) => {
        ...
        var url = `http://localhost:5000/inventory/advance-search/${make}/${model}/${trim}/${year}/${priceValue[0]*1000}/${priceValue[1]*1000}/${mileageValue[0]*1000}/${mileageValue[1]*1000}/${dayValue[0]}/${dayValue[1]}/${cylinder}/${cylinderType}/${condition}/${extColor}/${intColor}/${extColType}/${sort}`;
                            ...
                            >
                                <Grid container
                                    ...
                                    <Grid item p={2} sm={4} >
                                        <div className={classes.rootSlider}>
                                        <Typography id="range-slider" gutterBottom>
                                            Days on RAC's<Typography variant="body2" color="textSecondary">
                                                (0 Days to 200 Days)
                                            </Typography>
                                        </Typography>
                                        <Slider
